...
const ClearUserLogo: FC<IClearUserLogo> = ({ letter, width, height, latterSize }) => {
	...
	return (
		...
		>
			<Text className='font-bold text-white' style={{fontSize: latterSize ? latterSize : 40  }}>{FirstLatter}</Text>
		</View>
	)
}
