...
import { useAddBookToFavoriteMutation, useDeleteBookFromFavoriteMutation } from '../../../store/api/books'
...
const BookFavoritesButton: FC<IFavoriteButon> = ({ book, Profile, StateUser }) => {
